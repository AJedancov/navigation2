...
TEST_F(ProgressCheckerSelectorTestFixture, test_custom_topic)
{
    ...
    R"(
      <root BTCPP_format="4">
        <BehaviorTree ID="MainTree">
          <ProgressCheckerSelector selected_progress_checker="{selected_progress_checker}" default_progress_checker="simple_progress_check" topic_name="progress_checker_selector_custom_topic_name"/>
        </BehaviorTree>
      </root>)";
  ...
  EXPECT_EQ(selected_progress_checker_result, "simple_progress_check");
